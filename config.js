...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '265884736008-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Pixelz1130;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '265',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"Pixelz1130",
    BOT_NAME: process.env.BOT_NAME || 'Pixel1130',
